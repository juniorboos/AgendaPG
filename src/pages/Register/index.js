...
export default function Register({ navigation }) {
   ...
   const onRegistry = () => {
      ...
      if (form.cpf == "") {
         setIsLoading(false);
         return createButtonAlert("ERRO", "O campo CPF deve ser preenchido e ser válido!");
      }
   ...
   return (
      <View style={styles.wrapper}>
         <AppBar
            ...
            renderCenter={
               <Image style={{width: 150, height: 28}} source={require('../../assets/logo.png')} />
            }
         />
